...
def request_page(page: str, includeHeader: bool) -> any:
    ...
    if includeHeader:
        return curl_cffi.get(page, impersonate="firefox", headers=HEADERS, timeout=80)
    else:
        return curl_cffi.get(page, impersonate="firefox", timeout=80)
